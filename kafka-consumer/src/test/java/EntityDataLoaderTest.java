...
public class EntityDataLoaderTest {
    ...
    public void startStreams() throws Exception {
        ...
        streamsConfiguration
            .put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, kafkaUnitServer.getKafkaConnect());
        ...
        String json =
            "{\"date\":{\"string\":\"2017-03-20\"},\"time\":{\"string\":\"20:04:13:563\"},"
                ...
                + "\"date_time\":1490040253563,\"entity\":\"Transaction Manager\",\"state\":0,\"msg_param_1\""
                + ":{\"string\":\"ISWSnk\"},\"msg_param_2\":{\"string\":\"Application startup\"},"
                ...
                + "\"long_msg_param_8\":null,\"long_msg_param_9\":null,\"last_sent\":{"
                + "\"long\":1490040253563},\"transmit_count\":{\"int\":1},\"team_id\":null,\"app_id\":{"
                + "\"int\":4},\"logged_by_app_id\":{\"int\":4},"
                + "\"entity_type\":{\"int\":3},\"binary_data\":null}";

        ProducerRecord<byte[], String> keyedMessage = new ProducerRecord<>(
            EntityDataLoader.TOPIC_NAME, "key".getBytes(), json);
        Future<RecordMetadata> future = new KafkaProducer<>(streamsConfiguration,
            new ByteArraySerializer(), new StringSerializer()).send(keyedMessage);
